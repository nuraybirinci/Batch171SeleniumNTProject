...
public class C02_DriverMethodsTest {
    public static void main(String[] args) {
        ...
        System.out.println("Handle Değeri : "+amazonWindowHandleDegeri);
        /*
        Bir sayfaya gitikten sonra yeni sekmede yade  pencerede  başka bir sayfaya gitmemiz istenebilir ve
        tekrar ilk açtığımız sayfaya dönmemiz istenirse, ilk sayfaya dönebilmek için sayfanın handle değeri gerekir.
        Buna ilk sayfaya get() methodu ile gittikten sonra o sayfanın handle değerini getWindowHandle() methodu ile
        string bir değişken assign ederek çok rahat alabiliriz ve bu aldığımız handle değeri ile switch() methodunu
