...
public class C02_Iframe extends TestBase{
    ...
    public void iframe() {
        ...
        //driver.navigate().refresh();  -->refresh çeşidi. sayfayı yeniler Ana sayfaya döner fakat frame içinde yapılan değişikliklerde ilk haline döner
        //driver.get(driver.getCurrentUrl());  -->refresh çeşidi
